...
public class AnimalTest {
    ...
    @Test
    public void devoListarAnimalPeloNome(){
    ...
    public void deveOrdenarListaDeAnimaisPeloID(){
        ...
        Animal a1 = new Animal(2L, "Tartaruga");
        Animal a2 = new Animal(5L, "Coelho");
        Animal a3 = new Animal(1L, "Cachorro");
        Animal a4 = new Animal(6L, "Gato");
        Animal a5 = new Animal(3L, "Girafa");
